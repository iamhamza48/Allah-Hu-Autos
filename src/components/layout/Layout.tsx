    ...
    <div className="flex min-h-screen flex-col">
      ...
      {!hideWhatsApp && (
        <a
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center h-14 w-14 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] text-white shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
        >
