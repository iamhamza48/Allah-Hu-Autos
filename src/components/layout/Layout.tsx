    ...
    <div className="flex min-h-screen flex-col">
      ...
      {!hideWhatsApp && (
        <a
          ...
          className="whatsapp-float fixed bottom-5 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-emerald-950/20 transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-[#1ebe5d] hover:shadow-xl active:translate-y-0 active:scale-95 sm:bottom-6 sm:right-6"
        >
