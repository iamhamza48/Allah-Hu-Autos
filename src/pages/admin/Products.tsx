          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="details" className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div><Label>Price (PKR)</Label><Input type="number" value={form.base_price} onChange={e => setForm({ ...form, base_price: +e.target.value })} className="mt-1" /></div>
                <div><Label>Compare Price</Label><Input type="number" value={form.compare_price} onChange={e => setForm({ ...form, compare_price: +e.target.value })} className="mt-1" /></div>
              </div>
