...
const AdminCategories = () => {
  ...
  const openCreate = () => {
    setEditing(null); setForm({ name: '', slug: '', icon: '', featured: false }); setDialogOpen(true);
  };

  const openEdit = (c: Category) => {
    setEditing(c); setForm({ name: c.name, slug: c.slug, icon: c.icon, featured: c.featured }); setDialogOpen(true);
  };
